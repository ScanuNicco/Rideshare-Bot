...
module.exports = {
	...
	async execute(interaction) {
		...
		const message = await interaction.channel.send("**" + target.username + "** is offering a ride to `" + dest + "` on `" + when + "`. " + (payment ? "He/she is requesting that you help cover the cost of parking/gas. " : "") + "\n\n*Additional Info:*\n" + (info ?? "None"));
		//console.log(message);
